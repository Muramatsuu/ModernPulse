...
#[derive(Debug)]
pub struct ModernPulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModernPulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModernPulse processing");
    
    let mut processor = ModernPulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModernPulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModernPulseProcessor::new(false);
